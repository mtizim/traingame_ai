...
enum Routes {
  ...
  Madrid_Pamplona2({Cities.Madrid, Cities.Pamplona}, 3),
  ...
  Pamplona_Paris2({Cities.Pamplona, Cities.Paris}, 4),
  ...
  Dieppe_London2({Cities.Dieppe, Cities.London}, 2),
  London_Edinburgh({Cities.London, Cities.Edinburgh}, 4),
  London_Edinburgh2({Cities.London, Cities.Edinburgh}, 4),
  ...
  Paris_Brussels2({Cities.Paris, Cities.Brussels}, 2),
  ...
  Paris_Frankfurt2({Cities.Paris, Cities.Frankfurt}, 3),
  ...
  Munich_Venice({Cities.Munich, Cities.Venice}, 2),
  Frankfurt_Berlin({Cities.Frankfurt, Cities.Berlin}, 3),
  Frankfurt_Berlin2({Cities.Frankfurt, Cities.Berlin}, 3),
  ...
  Essen_Copenhagen2({Cities.Essen, Cities.Copenhagen}, 3),
  Copenhagen_Stockholm({Cities.Copenhagen, Cities.Stockholm}, 3),
  Copenhagen_Stockholm2({Cities.Copenhagen, Cities.Stockholm}, 3),
  ...
  Vilnius_Kyiv({Cities.Kyiv, Cities.Vilnius}, 2),
  ...
  Berlin_Warsaw2({Cities.Berlin, Cities.Warsaw}, 4),
  ...
  Vienna_Budapest2({Cities.Vienna, Cities.Budapest}, 1),
  ...
  static const leftRoutes = {
    ...
    Routes.London_Edinburgh,
    Routes.Paris_Brussels,
    Routes.Paris_Frankfurt,
    Routes.Frankfurt_Berlin,
    Routes.Essen_Copenhagen,
  ...
  static const rightRoutes = {
    ...
    Routes.London_Edinburgh2,
    Routes.Paris_Brussels2,
    Routes.Paris_Frankfurt2,
    Routes.Frankfurt_Berlin2,
    Routes.Essen_Copenhagen2,
